...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainContext.current_file_path = get(KEY_VIDEO_PATH);
        if (MainContext.current_file_path == null) {
            MainContext.current_file_path = "/mnt/sdcard/Download/VID_20140307_231413.mov";
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.capture:
                ...
                intent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, 70);
    ...
    private Uri getOutputMediaFileUri() {
        ...
        mCurrentFilePath = videoFile.getAbsolutePath();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            // TODO
            save(KEY_VIDEO_PATH, mCurrentFilePath);
            MainContext.current_file_path = mCurrentFilePath;
        }
    }
}
